...
class MesureHommeController extends AbstractController
{
    ...
    /**
     * @Route("/mes", name="mesure_homme_index2", methods={"GET"})
     */
    public function index2(MesureHommeRepository $mesureHommeRepository): Response
    {
        return $this->render('mesure_homme/index2.html.twig', [
            'mesure_hommes' => $mesureHommeRepository->findAll(),
        ]);
    }
